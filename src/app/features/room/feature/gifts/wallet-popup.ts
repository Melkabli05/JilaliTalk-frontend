...
@Component({
  ...
  `,
  styles: [`
    .wallet-popup { padding: var(--space-3); background: var(--color-card); border-radius: var(--radius-lg); border: 1px solid var(--color-border); }
    .wallet-balance { display: flex; flex-direction: column; gap: 2px; }
    .balance-label { font-size: var(--text-xs); color: var(--color-text-secondary); }
    .balance-value { font-size: var(--text-lg); font-weight: var(--font-bold); color: var(--color-text); }
